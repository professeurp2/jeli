...
TEXTS = {
    "en": {
        ...
        "source_organiser": "organiser",
        "reminder_too_far": "That's a long way off ⏰ I can remind you up to two months ahead.",
        "reminder_past": "That moment has already gone by ⏰ Tell me a time still to come and I'll be there.",
        ...
        "reminder_not_private": "Noted ⏰ One thing: I don't have your number, so I can't write to you privately yet. Send it to me — your name and your number — and I'll set the reminder straight away.",
        "identity_kept": "Got it, {name} — I'll remember. 🤝",
        "identity_kept_number": "Got it, {name} — I have your number now, and I'll write to you there. 🤝",
        "identity_settled": "And your reminder is set: I'll message you privately in time. ⏰",
        "identity_unclear": "I didn't catch that number 🤔 Send it with the country code, like +223 93 05 69 36.",
    ...
    "fr": {
        ...
        "source_organiser": "organisateur",
        "reminder_too_far": "C'est loin ⏰ Je peux te prévenir jusqu'à deux mois à l'avance.",
        "reminder_past": "Ce moment est déjà passé ⏰ Donne-moi une heure à venir et j'y serai.",
        ...
        "reminder_not_private": "C'est noté ⏰ Un détail : je n'ai pas ton numéro, donc je ne peux pas encore t'écrire en privé. Envoie-le-moi — ton nom et ton numéro — et je programme le rappel tout de suite.",
        "identity_kept": "C'est enregistré, {name} — je m'en souviendrai. 🤝",
        "identity_kept_number": "C'est enregistré, {name} — j'ai ton numéro, je t'écrirai là-bas. 🤝",
        "identity_settled": "Et ton rappel est programmé : je te préviens en privé à temps. ⏰",
        "identity_unclear": "Je n'ai pas bien saisi le numéro 🤔 Envoie-le avec l'indicatif, comme +223 93 05 69 36.",
