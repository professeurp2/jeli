...
FIELDS = {
    ...
    for field in (
        ...
        # "same": the voice of the voice notes, so Jeli sounds like itself everywhere. A call can
        # still be given its own character when the team wants one.
        Field("call_voice", "choice", lambda s: "same",
              choices=("same", "aoede", "puck", "charon", "kore", "fenrir")),
